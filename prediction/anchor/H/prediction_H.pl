...
$path_output="${path2}H/separated/"; # PARAMETER
$path_scratch="${path2}H/";  # PARAMETER
system "mkdir -p $path_output";

@model_dir1=glob "./model/anchor/H/*set1_eva"; # PARAMETER: F/G/H/I
@model_dir2=glob "./model/anchor/H/*set2_eva"; # PARAMETER
