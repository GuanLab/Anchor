...
$path_output="${path2}G/separated/"; # PARAMETER
$path_scratch="${path2}G/";  # PARAMETER
system "mkdir -p $path_output";

@model_dir1=glob "./model/anchor/G/*set1_eva"; # PARAMETER: F/G/H/I
@model_dir2=glob "./model/anchor/G/*set2_eva"; # PARAMETER
