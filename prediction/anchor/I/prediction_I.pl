...
$path_output="${path2}I/separated/"; # PARAMETER
$path_scratch="${path2}I/";  # PARAMETER
system "mkdir -p $path_output";

@model_dir1=glob "./model/anchor/I/*set1_eva"; # PARAMETER: F/G/H/I
@model_dir2=glob "./model/anchor/I/*set2_eva"; # PARAMETER
